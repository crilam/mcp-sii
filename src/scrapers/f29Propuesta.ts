...
import { URL_ADAPTER, NS_ADAPTER, FORM_CODIGO, FORM_ID, assertSinErrores } from './propuestaf29ui';
...
// normal, así que va por el mismo sobre `postSdi` que el RCV. Su base, su
// namespace —`lob.iva`— y la validación del sobre viven en
// `propuestaf29ui.ts`, compartidos con el scraper de PPM.
